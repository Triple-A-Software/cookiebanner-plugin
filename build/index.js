  ...
  ctx.registerElementType({
    ...
    <div id="cookie-bottom-banner" tabindex="-1" class="hidden">
        ...
        <div class="cookie-banner-btn-container">
            <button id="acceptAllCookies" type="button" class="cookie-banner-btn bg-green-700 hover:bg-green-800">Alle
                akzeptieren</button>
            <button id="declineAllCookies" type="button" class="cookie-banner-btn bg-red-700 hover:bg-red-800">Alle
                ablehnen</button>
                ...
                <div class="cookie-banner-modal-body">
                    ...
                    <div class="cookie-banner-modal-body-container">
                        <div class="cookie-banner-modal-body-btn-container">
                            ...
                            <label class="inline-flex items-center cursor-pointer" id="functional-cookie-toggle">
                                <input type="checkbox" checked class="sr-only peer" disabled id="functional-cookie">
                                <div
              ...
              default: {
                ...
                rewriter2.on("*:first-child", {
                  ...
                  element(el_) {
                    ...
                    el_.setAttribute("data-type", el.tagName);
                    el_.setAttribute("data-content", content);
                    foundFirst = true;
                  }
                });
